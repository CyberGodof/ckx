export interface User {
  ...
  name: string;
  companyId?: string; // legacy insurer/company link for jobs
  organizations?: string[]; // organizations (companies using the system) the user belongs to
  phone?: string;
  address?: string;
...
// Organizations represent companies using the system (tenants)
...
export interface Manual {
  id: string;
  companyId?: string; // Undefined = default (applies to all companies)
  category: string; // e.g., "Geyser Replacement", etc.
  title: string;
...
export type AdvertisementPlacement = "login" | "app";
export type AdvertisementMediaType = "image";
export type AdvertisementOrientation = "vertical" | "horizontal" | "auto";

export interface Advertisement {
  id: string;
  placement: AdvertisementPlacement;
  mediaType: AdvertisementMediaType;
  mediaUrl: string; // uploaded path or external link
  orientation?: AdvertisementOrientation;
  companyId?: string; // undefined for global
  startAt?: string;
  endAt?: string;
  isActive: boolean;
  createdBy: string;
